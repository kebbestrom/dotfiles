...
-- Do not loose selection when shifting in visual mode
...
vim.api.nvim_create_autocmd("TextYankPost", {
  ...
  group = vim.api.nvim_create_augroup("kebbe-highlight-yank", { clear = true }),
  callback = function()
...
vim.api.nvim_create_autocmd("BufWritePre", {
  ...
  group = vim.api.nvim_create_augroup("kebbe-js-formatting", {}),
})
  ...
  { "Bilal2453/luvit-meta", lazy = true },
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        group = vim.api.nvim_create_augroup("kebbe-lsp-attach", { clear = true }),
        callback = function(event)
          ...
          map("<leader>cr", vim.lsp.buf.rename, "Rename code symbol")
          ...
          if client and client.supports_method(vim.lsp.protocol.Methods.textDocument_documentHighlight) then
            local highlight_augroup = vim.api.nvim_create_augroup("kebbe-lsp-highlight", { clear = false })
            ...
            vim.api.nvim_create_autocmd("LspDetach", {
              group = vim.api.nvim_create_augroup("kebbe-lsp-detach", { clear = true }),
              callback = function(event2)
                vim.lsp.buf.clear_references()
                vim.api.nvim_clear_autocmds({ group = "kebbe-lsp-highlight", buffer = event2.buf })
              end,
            })
          end
      ...
      local servers = {
        ...
        ltex = {
          ...
          settings = {
            ltex = {
              dictionary = '{"en-US": [":~/.config/nvim/dictionary.txt"]}',
              disabledRules = '{"en-US": [":~/.config/nvim/disabled_rules.txt"]}',
              enabledRules = '{"en-US": [":~/.config/nvim/enabled_rules.txt"]}',
              hiddenFalsePositives = '{"en-US": [":~/.config/nvim/hidden_positives.txt"]}',
              checkFrequency = "save",
              additionalRules = {
